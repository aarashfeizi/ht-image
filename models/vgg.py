...
def _vgg(arch, cfg, batch_norm, pretrained, project_path, **kwargs):
    if pretrained:
...
def vgg16(args, pretrained=False, progress=True, mask=False, fourth_dim=False, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _vgg('vgg16', 'D', False, pretrained, project_path=args.project_path, **kwargs)


def vgg16_bn(args, pretrained=False, progress=True, mask=False, fourth_dim=False, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _vgg('vgg16_bn', 'D', True, pretrained, project_path=args.project_path, **kwargs)

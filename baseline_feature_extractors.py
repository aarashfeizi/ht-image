...
def main():
    ...
    if len(unique_seens) == 2:
        seen_res = utils.evaluation(embbeddings[seens == 1], labels[seens == 1],
                                    ids[seens == 1], model_methods.writer, loader, Kset=[1, 2, 4, 5, 8, 10, 100, 1000], split='seen')
